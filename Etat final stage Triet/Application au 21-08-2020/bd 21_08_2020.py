...
####### table sensor est divisé en 2 tables sensor_ref et sensor

## sensor_ref contient id_type_sensor ayant référence avec type_sensor table et une attribute type (BME280, BMP388)
drop_sensor_ref_table = """DROP TABLE IF EXISTS sensor_ref;"""
sensor_ref = """CREATE TABLE sensor_ref(
                id serial PRIMARY KEY,
                id_type_sensor int REFERENCES type_sensor(id),
                type varchar(20)
);"""
drop_table.append(drop_sensor_ref_table)
create_table.append(sensor_ref)

# sensor contient id_sensor_ref ayant référence avec sensor_ref table et les autres attributes comme ci_dessous
drop_sensor_table = """DROP TABLE IF EXISTS sensor;"""
sensor = """CREATE TABLE sensor(
                id serial PRIMARY KEY,
                id_sensor_ref int REFERENCES sensor_ref(id),
                number varchar(20),
                state varchar(20),
                validate boolean
);"""
